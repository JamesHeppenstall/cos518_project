...
func TestForgetMem(t *testing.T) {
	...
	if m2.Alloc > (m1.Alloc / 2) {
		t.Fatalf("%v > %v memory use did not shrink enough", m2.Alloc, (m1.Alloc / 2))
	}
...
// Benchmark_3 - Number of Paxos servers = 3 (t=1)
...
// Benchmark_5 - Number of Paxos servers = 5 (t=2)
...
// Benchmark_11 - Number of Paxos servers = 11 (t=5)
